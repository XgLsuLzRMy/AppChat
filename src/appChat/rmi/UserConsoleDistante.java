...
public class UserConsoleDistante {
	 ...
	 * 
	 * case 0: appDistant.logout(this.utilisateurServeur.getUtilisateur()); break;
	 * 
	 * case 1: System.out.print("Ecrire le contenu du tweet à publier : "); str =
	 * lecture.nextLine(); while (str.isEmpty() == true) { str = lecture.nextLine();
	 * }
	 * 
	 ...
	 * this.utilisateurServeur.getUtilisateur().getFollowCount() + " utilisateurs");
	 * System.out.println("Vous etes suivi par " +
	 ...
	 * this.utilisateurServeur.getUtilisateur().getListMessagesRecents().
	 * getNbMaxMessage());
	 * System.out.println("Donner le nouveau nombre max de messages récents : "); nb
	 * = Integer.parseInt(lecture.nextLine()); if (nb >= 0) {
	 * this.utilisateurServeur.getUtilisateur().getListMessagesRecents().
	 * setNbMaxMessage(nb);
	 * 
	 * try { UserConsoleDistante.appDistant.getUtilisateur(this.utilisateurServeur.
	 ...
	 * System.out.println("Nombre incorrect, on ne change rien"); } break; case 6:
	 * System.out.println(this.utilisateurServeur.getUtilisateur().

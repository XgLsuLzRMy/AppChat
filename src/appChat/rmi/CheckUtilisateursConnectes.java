...
public class CheckUtilisateursConnectes extends Thread {
	...
	public void run() {
		while (true) {
			...
			/*
			 * if (changement) { System.out.
			 * println("On refresh l'affichage de la liste des utilisateurs connectes"); i =
			 * 0; while(i < AppRMIServeurImpl.utilisateursConnectes.length()) { u =
